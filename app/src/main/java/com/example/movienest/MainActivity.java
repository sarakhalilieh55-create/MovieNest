...
public class MainActivity extends AppCompatActivity {
    ...
    private void init()
    {
        ...
        listType = listType;
        bottomNavigationView = findViewById(R.id.btnLoginLogin);
        bottomNavigationView.setOnItemSelectedListener(new NavigationBarView.OnItemSelectedListener() {
            ...
            /*
                ...
                else if (item.getItemId() == R.id.btnSignupSignup) {
                    signout();
    ...
    {
        @SuppressLint("RestrictedApi") final User[] currentUser = {null};
        try {
                        ...
                        public void onComplete(@NonNull Task<QuerySnapshot> task) {
                            if (task.isSuccessful()) {
                                for (QueryDocumentSnapshot document : task.getResult()) {
                                    ...
                                    if (fbs.getAuth().getCurrentUser() != null && (fbs.getAuth().getCurrentUser().getEmail().equals(user.getUid()))) {
    ...
    private class ListFragmentType {
    }
}
